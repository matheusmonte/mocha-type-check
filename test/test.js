...
describe('nestedTypeFilter', function() {
  ...
  it('fitlers value if not Number', function() {
    testHelper(true, Number, undefined);
  });
  it('fitlers value if not String', function() {
    testHelper(5, String, undefined);
  });
  it('fitlers value if not Boolean', function() {
  ...
  it('handles nested object', function() {
    testHelper({
      a: 'aa',
      b: {
        foo: '',
  ...
  it('handles arbitrarily deep object', function() {
    testHelper(generateDeepObjects(7), generateDeepSpec(7), generateDeepObjects(7));
  })
  it('handles object spec inside of array', function() {
    testHelper([{
      a: 1, b: 'str'
    }, {
      a: 'str', b: 2
